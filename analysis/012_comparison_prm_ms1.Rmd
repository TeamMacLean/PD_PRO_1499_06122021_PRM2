...
```{r, warning=FALSE}
prm_filepath = paste0(here::here(), "/data/raw/M_oryzae_PRM_TEMP_07_with_spectra_refined_Guy11_deltaPmk1_timecourse_for_thesis_copy.xlsx")
...
```{r}
readr::write_csv(clean_tidy_prm_data, here::here("data", "cleaned", "012_clean_tidy_prm_scaled_data.csv"))
```
...
```{r}
ms1_filepath = paste0(here::here(), "/data/raw/Nrc210121_rgm2r_1to6hrsMS1Q.xlsx")
...
```{r}
readr::write_csv(clean_tidy_ms1_scaled_data, here::here("data", "cleaned", "012_clean_tidy_ms1_scaled_data.csv"))
```

## COMPARISON

Let's prep the data sets
...
```{r}
pdf_filename = here::here("graphics", "012-all-prm-ms1-comparison-plots.pdf")
