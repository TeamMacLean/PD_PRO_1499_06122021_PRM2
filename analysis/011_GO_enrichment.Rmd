...
```{r}
targets = readxl::read_xlsx("Pmk1 direct targets PRM_101122.xlsx") %>% 
  dplyr::select(`Phosphorylation position`) %>% unique()
```

Keep only the gene id (for now I remove gi number)
Replacement:

gi|145610929|ref|XP_368444.2| MST7  = MGG_00800
gi|39964959|ref|XP_365053.1| MAC1 (S75) = MGG_09898
...
csv_filename = "011_targets_go_enrichment.csv"
