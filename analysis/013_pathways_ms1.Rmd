...
```{r}
ht_list = hm_list[[1]] %v% hm_list[[2]] %v% hm_list[[3]] %v% hm_list[[4]] %v% hm_list[[5]] %v% hm_list[[6]]

graphics_dir = paste(here(), "graphics", sep = "/")
pdf_filename = paste(graphics_dir, "013-ms1-pathways.pdf", sep = "/")
pdf(file = pdf_filename, height = 11.69, width = 8.27)
